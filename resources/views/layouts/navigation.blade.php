...
<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <nav class="mt-10" x-data="{ isMultiLevelMenuOpen: false }">
        ...
        <x-nav-link href="{{ route('users.transactions') }}" :active="request()->routeIs('users.transactions')">
            <x-slot name="icon">
        ...
        <x-nav-link href="{{ route('admin.wallets') }}" :active="request()->routeIs('admin.wallets')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <x-nav-link href="{{ route('profile.wallets') }}" :active="request()->routeIs('profile.wallets')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <x-nav-link href="{{ route('profile.testimonials') }}" :active="request()->routeIs('profile.testimonials')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
