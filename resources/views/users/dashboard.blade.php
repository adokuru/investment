            ...
            <div class="earn-item mb-30">
                ...
                <div class="earn-content">
                    ...
                    <ul class="mb--5">
                        ...
                        <li>
                            <div class="icon">
                                <img src="{{ asset('backend/assets/images/dashboard/earn/eth.png') }}"
                                    alt="dashboard-earn">
                            </div>
                            <div class="cont">
                                <span
                                    class="cl-1">{{ $btcashwallet != null ? $btcashwallet->amount : '0.000000' }}</span>
                                <span class="cl-4">BCH</span>
                            </div>
                        </li>
                        <li>
                            <div class="icon">
                                <img src="{{ asset('backend/assets/images/dashboard/earn/usd.png') }}"
                                    alt="dashboard-earn">
                            </div>
                            <div class="cont">
...
@section('script')
    <script>
        let values =
            {{ $investment != null ? $investment->days_remaining() / $investment->investment->contract_duration : 0 }};
