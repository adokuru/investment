<x-app-layout>
    ...
    <form action="{{ route('admin.users.update', $user->id) }}" method="POST" class="space-y-8 w-full divide-y divide-gray-200">
        @csrf
            ...
            <div class="pt-8">
                ...
                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-2 mt-4">
                        ...
                        <div class="mt-1">
                            <input type="text" value="{{ $user->earnings }}" name="earnings" id="earnings" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                    </div>
                </div>
            </div>
