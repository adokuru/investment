        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="team-item">
                        <div class="top card-overlay">
                            <img src="{{ asset('frontend-assets/img/team/team4.jpg') }}" alt="Team">
                        </div>
                        <div class="bottom">
                            <ul>
                                <li>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="team-item">
                        <div class="top card-overlay">
                            <img src="{{ asset('frontend-assets/img/team/team5.jpg') }}" alt="Team">
                        </div>
                        <div class="bottom">
                            <ul>
                                <li>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="team-item">
                        <div class="top card-overlay">
                            <img src="{{ asset('frontend-assets/img/team/team6.jpg') }}" alt="Team">
                        </div>
                        <div class="bottom">
                            <ul>
                                <li>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="team-item">
                        <div class="top card-overlay">
                            <img src="{{ asset('frontend-assets/img/team/team7.jpg') }}" alt="Team">
                        </div>
                        <div class="bottom">
                            <ul>
                                <li>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="team-item">
                        <div class="top card-overlay">
                            <img src="{{ asset('frontend-assets/img/team/team8.jpg') }}" alt="Team">
                        </div>
                        <div class="bottom">
                            <ul>
                                <li>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="team-item">
                        <div class="top card-overlay">
                            <img src="{{ asset('frontend-assets/img/team/team9.jpg') }}" alt="Team">
                        </div>
                        <div class="bottom">
                            <ul>
                                <li>
